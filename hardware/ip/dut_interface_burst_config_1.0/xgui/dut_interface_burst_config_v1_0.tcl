...
proc init_gui { IPINST } {
	...
	set C_S01_AXI_DATA_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S01_AXI_DATA_WIDTH]
	set_property tooltip {Width of S_AXI data bus} $C_S01_AXI_DATA_WIDTH
	set C_S01_AXI_ADDR_WIDTH [ipgui::add_param $IPINST -parent $Page0 -name C_S01_AXI_ADDR_WIDTH]
	set_property tooltip {Width of S_AXI address bus} $C_S01_AXI_ADDR_WIDTH
	set C_S01_AXI_BASEADDR [ipgui::add_param $IPINST -parent $Page0 -name C_S01_AXI_BASEADDR]
	set C_S01_AXI_HIGHADDR [ipgui::add_param $IPINST -parent $Page0 -name C_S01_AXI_HIGHADDR]
}
...
proc update_MODELPARAM_VALUE.DUT_BUS_WIDTH { MODELPARAM_VALUE.DUT_BUS_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	# WARNING: There is no corresponding user parameter named "DUT_BUS_WIDTH". Setting updated value from the model parameter.
set_property value 32 ${MODELPARAM_VALUE.DUT_BUS_WIDTH}
}
